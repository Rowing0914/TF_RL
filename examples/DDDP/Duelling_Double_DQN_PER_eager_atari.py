...
if __name__ == '__main__':
	...
	if params.google_colab:
		...
		params.log_dir         = "/content/TF_RL/logs/logs/DDDP/{}".format(params.env_name)
		params.model_dir       = "/content/TF_RL/logs/models/DDDP/{}".format(params.env_name)
		params.log_dir_colab   = "/content/gdrive/My Drive/logs/logs/DDDP/{}".format(params.env_name)
		params.model_dir_colab = "/content/gdrive/My Drive/logs/models/DDDP/{}".format(params.env_name)
		...
		if params.debug_flg:
			...
			agent = Double_DQN(Model, Model, env.action_space.n, params)
	else:
		# run on the local machine
		if params.debug_flg:
			params.log_dir = "../../logs/logs/" + now.strftime("%Y%m%d-%H%M%S") + "DDDP_debug/"
			params.model_dir = "../../logs/models/" + now.strftime("%Y%m%d-%H%M%S") + "DDDP_debug/"
			agent = Double_DQN_debug(Model, Model, env.action_space.n, params)
		else:
