...
parser.add_argument("--eval_interval", default=250_000, type=int, help="a frequency of evaluation during training")
parser.add_argument("--memory_size", default=1_000_000, type=int, help="memory size in a training")
parser.add_argument("--learning_start", default=80_000, type=int, help="when to start updating the agent")
...
parser.add_argument("--decay_steps", default=1_000_000, type=int, help="period for annealing a value(epsilon or beta)")
