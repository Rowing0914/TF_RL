...
import copy
import numpy as np
from examples.DQN.pytorch.network import net
...
class DQN(object):
    ...
    def _update(self, states, actions, rewards, next_states, dones):
        ...
        self.summary_writer.add_scalar('agent/mean_diff_q_tp1_q_t', (target_action_value - action_value).mean(), self.timestep)
