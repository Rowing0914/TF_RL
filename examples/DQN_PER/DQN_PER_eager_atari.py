...
if __name__ == '__main__':
	...
	if params.google_colab:
		...
		params.log_dir         = "/content/TF_RL/logs/logs/DQN_PER/{}".format(params.env_name)
		params.model_dir       = "/content/TF_RL/logs/models/DQN_PER/{}".format(params.env_name)
		params.log_dir_colab   = "/content/gdrive/My Drive/logs/logs/DQN_PER/{}".format(params.env_name)
		params.model_dir_colab = "/content/gdrive/My Drive/logs/models/DQN_PER/{}".format(params.env_name)
