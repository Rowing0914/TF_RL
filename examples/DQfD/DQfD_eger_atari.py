...
parser.add_argument("--grad_clip_flg", default="", help="types of a clipping method of gradients => by value(by_value) or global norm(norm) or None")
...
parser.add_argument("--eval_interval", default=2500, type=int, help="a frequency of evaluation occurring in training phase")
...
if params.google_colab:
	...
	params.log_dir, params.model_dir, params.log_dir_colab, params.model_dir_colab = setup_on_colab("DQfD", params.env_name)
else:
	if params.debug_flg:
