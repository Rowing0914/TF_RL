...
if __name__ == '__main__':
	...
	if params.google_colab:
		...
		params.log_dir = "/content/gdrive/My Drive/logs/logs/Double_DQN/{}".format(params.env_name)
		params.model_dir = "/content/gdrive/My Drive/logs/models/Double_DQN/{}".format(params.env_name)
