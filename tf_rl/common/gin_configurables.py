...
config.external_configurable(
    tf.optimizers.SGD, module='tf.optimizers')
config.external_configurable(
    tf.optimizers.Adadelta, module='tf.optimizers')
config.external_configurable(
    tf.optimizers.Adagrad, module='tf.optimizers')
config.external_configurable(
    tf.optimizers.Adam, module='tf.optimizers')
config.external_configurable(
    tf.optimizers.Ftrl, module='tf.optimizers')
config.external_configurable(
    tf.optimizers.RMSprop, module='tf.optimizers')
