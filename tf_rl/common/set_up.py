...
def set_up_for_training(log_dir_name, env_name, seed):
    ...
    logdir = {
        "summary_path": ROOT_DIR + "/logs/logs/{}/{}-{}-seed{}".format(log_dir_name, env_name, exp_date, seed),
        ...
        "traj_path": ROOT_DIR + "/logs/trajs/{}/{}-{}-seed{}".format(log_dir_name, env_name, exp_date, seed),
    }
    return logdir