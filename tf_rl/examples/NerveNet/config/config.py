...
import argparse
import config.init_path as init_path
...
def get_config():
    ...
    parser.add_argument("--task", type=str, default='CentipedeFour-v1',
...
def get_ggnn_config(parser):
    parser.add_argument("--use_gnn_as_policy", type=int, default=1,
